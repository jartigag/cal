...
function vobj_crea($classId,$userId,$teacherCoin,$teacherCoinSecret) {
	$r=file_get_contents('https://webalumnos.tlm.unavarra.es:10169/vobj/crea.php?nombre=diploma&desc='.$classId.'&icon=&propietario='.$userId.'&generador=1&coin='.$teacherCoin.'-'.$teacherCoinSecret);
